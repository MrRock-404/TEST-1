import os
print("\033[1;92m Lording... \033[1;30m")
os.system("pkg install espeak")
print("\033[1;92m  Tools Update  successful  \033[1;30m")
os.system('espeak -a 50 "successful "')
os.system("clear")
...
print("\033[1;92m  This Tools Is Spy Cyber Update Sms Bomber \033[1;30m")
os.system('espeak -a 50 "This tools is spy cyber update sms bomber "')
...
print(f""" 
 \033[1;93m=================================================
 \033[1;93m‌‌‌‌[+]    \033[1;96m[✓] CREATED BY\33[0;m   :  \033[1;96mMeraj Islam        \033[1;93m‌‌‌‌[+]
 \033[1;93m‌‌‌‌[+]    \033[1;32m[✓] FACEBOK      : \033[1;m Meraj Islam        \033[1;93m‌‌‌‌[+]
 \033[1;93m‌‌‌‌[+]    \033[1;m[✓] FB GROUP     : \33[1;49m Spy Cyber          \033[1;93m‌‌‌‌[+]
 \033[1;93m‌‌‌‌[+]    \033[1;35m[✓] GITHUB       :  \033[1;35mSpyCyber404        \033[1;93m‌‌‌‌[+]
...
number=input(f"{c}\n[ VICTIM NUMBER ] :{w} +880")
amo=int(input(c+"\n[ AMOUNT ] : "+w))
xak(f"\n\n\t {w}<{r}/{w}> {g}STAY WITH SPY CYBER  ;) {w}<{r}/{w}>\n\n")
...
os.system("xdg-open https://github.com/SpyCyber404")
print(f""" \033[1;31m            ➡️  WELCOME TO SPY CYBER WORLD ⚠️""")
print("""\x1b[38;5;46m
...
for i in range(amo):
	...
	print(f"\n\t\t {ran2}SMS SENT SUCCESFULLY💚  BY 🔥SPY CYBER 🔥 "+w+tim)
